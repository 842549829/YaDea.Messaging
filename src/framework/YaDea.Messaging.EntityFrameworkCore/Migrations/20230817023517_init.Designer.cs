...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YaDea.Messaging.Entities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("YaDea.Messaging.Entities.MessageNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("YaDea.Messaging.Entities.MessageScope", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("YaDea.Messaging.Entities.MessageNotification", b =>
                {
                    b.HasOne("YaDea.Messaging.Entities.Message", null)
                        .WithMany("Notifications")
                        .HasForeignKey("MessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YaDea.Messaging.Entities.MessageScope", null)
                        .WithMany("Notifications")
