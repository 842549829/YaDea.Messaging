...
namespace YaDea.Messaging.Identity.Services
{
    public class UserService : IUserService
    {
        ...
        public UserService(UserManager<AppUser> userManager, AppDbContext appDbContext, IOptions<JwtSettingOptions> jwtSettingOptions)
        {
        ...
        public async Task<TokenResult> RegisterAsync(string username, string password, string address)
        {
            ...
            var newUser = new AppUser { UserName = username, Description = address };
        ...
        private ClaimsPrincipal? GetClaimsPrincipalByToken(string token)
        {
            try
            {
                var tokenValidationParameters = new TokenValidationParameters
                {
                    ...
                    IssuerSigningKey = new SymmetricSecurityKey(Encoding.ASCII.GetBytes(_jwtSettingOptions.SecurityKey)),
        ...
        {
            var key = Encoding.ASCII.GetBytes(_jwtSettingOptions.SecurityKey);
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                Expires = DateTime.UtcNow.Add(_jwtSettingOptions.ExpiresIn),
            ...
            return new TokenResult()
            {
                ...
                ExpiresIn = (int)_jwtSettingOptions.ExpiresIn.TotalSeconds,
            };
        }
